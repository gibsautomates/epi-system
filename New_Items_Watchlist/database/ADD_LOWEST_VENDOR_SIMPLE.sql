-- ============================================
-- ADD LOWEST VENDOR TO ENHANCED VIEW (SIMPLE VERSION)
-- Uses vendor_list field to extract first vendor
-- ============================================
...
SELECT 
    ...
    -- For now, use the first vendor in the list as lowest vendor
    -- This is a simplification until we can properly join with vendor offers
    SPLIT_PART(nd.vendor_list, ', ', 1) as lowest_vendor,
